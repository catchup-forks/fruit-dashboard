            ...
            @if (count($profiles) > 0)
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <a href="{{ route('signup-wizard.getStep', SiteConstants::getSignupWizardStep('next', SiteConstants::getSignupWizardStep('next', $currentStep))) }}" class="btn btn-link pull-right">Skip</a>
                </div> <!-- /.col-md-12 -->
              </div> <!-- /.row -->
